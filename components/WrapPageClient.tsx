...
export default function WrapPageClient() {
    ...
    if (error) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-black gap-4 text-white">
                ...
                <button onClick={() => router.push('/')} className="rounded-lg bg-zinc-800 px-4 py-2 hover:bg-zinc-700">
                    Go Back
                </button>
            </div>
        );
